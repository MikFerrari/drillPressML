% FEATURE EXTRACTION (Load) → USE FILTERED DATA
...
% |Load operations|
names_acc_train = {'15_01_P','18_12am_P','20_11_P','23_12_P'};
names_acc_test = {'27_11_P'};
              
exclusions_train = {'15_01_P_5','18_12am_P_3','18_12am_P_4','18_12am_P_5','20_11_P_5'};
exclusions_test = {'27_11_P_5'};
...
acc_train = accelerations([idx_acc_train idx_acc_train idx_acc_train],:);
acc_test = accelerations([idx_acc_test idx_acc_test idx_acc_test],:);
