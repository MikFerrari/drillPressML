...
%                          extrFeatFromBuffers_NorP_manualFeat(acc_unfilt_train{i},recordLength,fs)];
    feat_filt_train = [feat_filt_train; ...
                       extrFeatFromBuffers_NorP_manualFeat(acc_filt_train{i},recordLength,fs)];
end
...
%                         extrFeatFromBuffers_NorP_manualFeat(acc_unfilt_test{i},recordLength,fs)];
    feat_filt_test = [feat_filt_test; ...
                      extrFeatFromBuffers_NorP_manualFeat(acc_filt_test{i},recordLength,fs)];
end
