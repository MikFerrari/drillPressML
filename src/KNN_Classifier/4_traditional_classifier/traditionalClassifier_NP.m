...
% [trainedClassifier, validationAccuracy] = trainClassifier_filt_NP(feat_filt_train);
[trainedClassifier, validationAccuracy] = trainClassifier_filt_NP_manualFeat(feat_filt_train);
