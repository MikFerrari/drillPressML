...
[trainedClassifier, validationAccuracy] = trainClassifier_filt_P(feat_filt_train);
% [trainedClassifier, validationAccuracy] = trainClassifier_filt_P_manualFeat(feat_filt_train);
save(strcat(modelsPath,'\KNNmodel_filt_P.mat'),'trainedClassifier');
